  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <Link href="/listening" className="flex items-center gap-1 text-sm mb-6" style={{ color: "hsl(var(--muted-foreground))" }}>
        <ArrowLeft className="w-4 h-4" /> Tất cả phần nghe
      </Link>
      <div className="text-center py-16">
        ...
        <div className="card p-6 mt-8 max-w-md mx-auto">
          ...
          <p className="text-xs" style={{ color: "hsl(var(--muted-foreground))" }}>Phần luyện tập này sẽ sớm ra mắt với audio và transcript đầy đủ. Hãy quay lại sau nhé!</p>
        </div>
      </div>
    </div>
  );
